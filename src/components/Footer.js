      ...
      <footer className="text-center bg-gray-900 text-white">
        <div class="container px-6 pt-6">
          <div class="flex justify-center mb-6">
            ...
            <a
              href="https://github.com/digitalsimboja"
              target="_blank"
          ...
          <div class="mb-6">
            <p>
              Subscribe to our weekly updates on recent happenings in Web3.0 and
              the Metaverse
            </p>
          </div>
          <div class="grid lg:grid-cols-4 md:grid-cols-2">
            <div class="mb-6">
              <h5 class="uppercase font-bold mb-2.5">Top Skills</h5>
